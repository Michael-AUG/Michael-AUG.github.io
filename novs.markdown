...
I have made use all of the above types of NoVs. A few of the variations from groups 1 and 2[^1] are listed below, with links to QRZ pages.
...
I also hold the following 'group 3'[^1]  NoVs:
